...
public class TopDownIntegrationTest {
    ...
    public void testAddCourse() {
        ...
        Course addedCourse = courseService.addCourseWTeacherAStudent(course, null, null);

        assertNotNull(addedCourse);
        assertTrue(addedCourse.getTeachers().isEmpty());
        assertTrue(addedCourse.getEnrolledStudents().isEmpty());
    }

    @Test //P -> A -> B
    public void testAddCourseWithStudent() {
        Student student = createStudent();
        Course course = createCourse();

        Course addedCourse = courseService.addCourseWTeacherAStudent(course, student, null);
    ...
    @Test //P -> A -> B -> C
    public void testAddCourseWithStudentAndTeacher() {
        Student student = createStudent();
